...
describe('Game (e2e)', () => {
  ...
  it('/game/:id (PATCH) returns 404 for unknown game', () => {
    return httpRequest()
      .patch('/game/unknown')
      .send({ label: 'missing' })
      .expect(404)
  ...
  it('/game/:id (DELETE) returns 404 for unknown game', () => {
    return httpRequest()
      .delete('/game/unknown')
      .expect(404)
      .expect((res) => {
  ...
  it('/graphql (POST) - createGame mutation', () => {
    return gqlRequest(
      'mutation CreateGame($input: CreateGameInput!) { createGame(input: $input) { id status humanSymbol aiSymbol nextTurn moveNumber label } }',
  ...
  it('/graphql (POST) - updateGame mutation', () => {
    return gqlRequest(
      'mutation UpdateGame($id: String!, $input: UpdateGameInput!) { updateGame(id: $id, input: $input) { id label } }',
  ...
  it('/graphql (POST) - updateGame mutation returns error for unknown game', () => {
    return gqlRequest(
      'mutation UpdateGame($id: String!, $input: UpdateGameInput!) { updateGame(id: $id, input: $input) { id } }',
